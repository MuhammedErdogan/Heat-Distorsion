...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        if (customEffect.IsActive())
        {
            ...
            material.SetFloat(Shader.PropertyToID("_FarClip"), customEffect.farClip.value);
            material.SetFloat(Shader.PropertyToID("_NearClip"), customEffect.nearClip.value);
            material.SetFloat(Shader.PropertyToID("_HeightStep"), customEffect.heightStep.value);
            material.SetFloat(Shader.PropertyToID("_HeightOffset"), customEffect.heightOffset.value);
            material.SetFloat(Shader.PropertyToID("_DustSpeed"), customEffect.dustSpeed.value);
            material.SetFloat(Shader.PropertyToID("_HeatDistortSpeed"), customEffect.heatDistortSpeed.value);
            BlitTo(material);
        }
